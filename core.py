...
install()
_theme = Theme({"cyan": "#00CED1", "gold": "#FFD700"})
...
class SecurityTool(object):
    ...
    def show_info(self):
        ...
        console.print(Panel(desc, title=f"[bold gold]{self.TITLE}[/bold gold]", border_style="cyan", box=box.DOUBLE))
    ...
    def show_options(self, parent=None):
        ...
        table.add_column("Action", style="bold gold")
...
class SecurityToolsCollection(object):
    TITLE: str = ""
    DESCRIPTION: str = ""
    TOOLS: List = []
    ...
    def show_info(self):
        console.rule(f"[bold cyan]{self.TITLE}[/bold cyan]", style="cyan")
        console.print(f"[italic gold]{self.DESCRIPTION}[/italic gold]\n")
    ...
    def show_options(self, parent=None):
        ...
        table.add_column("Tool Name", style="bold gold")
